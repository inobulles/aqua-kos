...
void glOrthof  (float left, float right, float top, float bottom, float near, float far) { esOrtho  (matrix_mode == GL_MODELVIEW ? &model_view_matrix : &projection_matrix, left, right, top, bottom, near, far); }
void glFrustumf(float left, float right, float top, float bottom, float near, float far) { esFrustum(matrix_mode == GL_MODELVIEW ? &model_view_matrix : &projection_matrix, left, right, top, bottom, near, far); }
