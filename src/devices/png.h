...
#ifndef __AQUA__KOS_DEVICES_PNG_H
	#define __AQUA__KOS_DEVICES_PNG_H
	...
	static void png_device_handle(unsigned long long** result, const char* data) {
		...
		unsigned char* image = stbi_load_from_memory((const stbi_uc*) command[0], command[1], (int*) &kos_bda_implementation.temp_value_field[1], (int*) &kos_bda_implementation.temp_value_field[2], (int*) &kos_bda_implementation.temp_value_field[3], STBI_rgb_alpha);
