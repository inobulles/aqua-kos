...
#define FT_CONFIG_STANDARD_LIBRARY_H  "freetype2/freetype/config/ftstdlib.h"
#endif
...
#define FT_TRUETYPE_DRIVER_H  "ftttdrv.h"
   ...
   *
   */
#define FT_PCF_DRIVER_H  "ftpcfdrv.h"
...
#define FT_PFR_H  "ftpfr.h"
   ...
   */
#define FT_STROKER_H  "../freetype2/freetype/ftstroke.h"
